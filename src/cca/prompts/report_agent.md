...
本节使用 dual_axis_bar 图：x 轴为各产品，左 y 轴为评论量（数值来自 rating_review_count），右 y 轴为口碑评分（数值来自 aggregate_rating）。评分与评论量量级悬殊，必须双轴分开展示，不得合并为单轴。若某产品 aggregate_rating 为 None（无统一评分），在图注中说明并跳过其评分柱。
